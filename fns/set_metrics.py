...
from ._set_metrics import hausdorff_distance_onesided_3d
...
def hausdorff_distance(a, b):
    ...
    a, b : ndarray, shape ``(N, M)``,dtype=float
        Array containing the coordinates of ``M`` points in an
        ``N`` dimensional space.
    ...
    return max(hausdorff_distance_onesided_3d(a, b),
               hausdorff_distance_onesided_3d(b, a))
