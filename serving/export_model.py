...
with tf.Session() as sess:
    ...
    sess.run(init)
    model = td.Model()
    model.add(net.predicter, sess)
    model.save("models/4-layers-16-features_u-net.pkl")


# In[12]:

import fns.tfdeploy as td
model = td.Model("models/4-layers-16-features_u-net.pkl")
